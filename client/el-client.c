...
main(int argc, char * argv[])
{
    ...
    GOptionEntry options[] =
    {
        ...
        {"start-time", 0, G_OPTION_FLAG_OPTIONAL_ARG, G_OPTION_ARG_INT64, &start_time, "Start time", "t"},
        {"end-time", 0, G_OPTION_FLAG_OPTIONAL_ARG, G_OPTION_ARG_INT64, &end_time, "End time", "t"},
